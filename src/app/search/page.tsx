...
// This is the main view of the search page
// It allows users to search for recipes based on the selected ingredients and display up to 20 recipe cards for users to see
